...
# Report a run with no achievement for this much game time and real time. 0 game minutes = off.
STALL_ALERT_GAME_MINUTES = int(_env("STALL_ALERT_GAME_MINUTES", "120"))
STALL_ALERT_REAL_MINUTES = int(_env("STALL_ALERT_REAL_MINUTES", "15"))
STALL_ALERT_REPEAT_HOURS = int(_env("STALL_ALERT_REPEAT_HOURS", "6"))
# Each stall keeps the moment it was noticed and the save from before it began. 0 = keep none.
...
def validate():
    ...
    ranges = {
        ...
        "STALL_ALERT_GAME_MINUTES": (STALL_ALERT_GAME_MINUTES, 0, 100000),
        "STALL_ALERT_REAL_MINUTES": (STALL_ALERT_REAL_MINUTES, 0, 100000),
        "STALL_ALERT_REPEAT_HOURS": (STALL_ALERT_REPEAT_HOURS, 1, 8760),
        "KEEP_STALL_BUNDLES": (KEEP_STALL_BUNDLES, 0, 1000),
