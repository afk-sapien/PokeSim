...
That builds the current default branch. Add `@v0.4.3` to the URL to pin a release, or install a
released wheel without Git:

```sh
pipx install https://github.com/afk-sapien/PokeSim/releases/download/v0.4.3/pokesim-0.4.3-py3-none-any.whl
```
