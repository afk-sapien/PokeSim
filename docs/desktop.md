...
That builds the current default branch. Add `@v0.3.1` to the URL to pin a release, or install a
released wheel without Git:

```sh
pipx install https://github.com/afk-sapien/PokeSim/releases/download/v0.3.1/pokesim-0.3.1-py3-none-any.whl
```
