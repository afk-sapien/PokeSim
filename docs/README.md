...
| Current server installation | [Server setup](../README.md#on-an-always-on-server) |
| Prebuilt release image | [Prebuilt rc31 installation](self-hosting.md) |
| Level 100 stars and perfect DV finds (development) | [Collection goals](collection-goals.md) |
...
| Distribution findings and implementation status | [Distribution readiness](distribution-readiness.md) |
