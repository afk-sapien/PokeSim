# Release and deployment history through September 15, 2026

Archived snapshot. Statements about current versions, pending work, and operational
authorization describe their original context. Consult the [documentation index](../README.md)
and [release status](../../RELEASE_STATUS.md) for the maintained summaries.
